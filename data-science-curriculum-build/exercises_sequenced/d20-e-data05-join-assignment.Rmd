...
- the arists were not in the same order for the Beatles1 and Beatles2
...
```{r q2-task}
df_q2 <- inner_join(beatles1, beatles3, by = 'name') %>%
  inner_join(beatles2,by='surname')
...
```{r q4-task}
criteria <- expand_grid(month= 8:9,dest = c('SFO', 'SJC','OAK'))
