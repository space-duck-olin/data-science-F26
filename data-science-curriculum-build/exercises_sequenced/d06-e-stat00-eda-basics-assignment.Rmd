...
**Observations**:
- That hypothesis is not true because Ideal cut has the greatest number of samples
...
**Observations**:
- This graph is not very effective at seeing if ideal diamonds are more expensive than other diamond cuts since all you see is a mostly solid black line. 
...
**Observations**:
- hypothesis two is not true because the highest average price is not in the ideal cuts. 
...
**Observations**:
- Yes, this carat over cut does make sense. 
