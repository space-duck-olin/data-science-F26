...
- How many aluminum alloys are in this dataset? How do you know?
  - There is only one aluminum alloy in this dataset as there is only one unique value in the alloy column.
...
- Yes nu does increase with increases in E as demonstrated by the postive slope in the trend line. 
...
- Does this graph support or contradict the claim above?
  - The graph very slightly contradicts the claim that material thickness changes the material properties
- Is this evidence *conclusive* one way or another?
  - This evidence is inconclusive one way or another as E and nu are not clustered by thickness. The thickest plates values seems to contradict the claim that a there is a single value between thickness. However, the three thinner plates do not follow the same pattern and their points are all intermixed.
