...
- There are five columns of data. For each passenger in a given class, age and sex, the data reports how many died or survived
...
df_titanic_survive <- df_titanic %>%
  filter(Survived == 'Yes')
df_titanic_survive %>%
  ggplot(aes(x = Class, y = n, group = Sex, colour = Sex)) +
